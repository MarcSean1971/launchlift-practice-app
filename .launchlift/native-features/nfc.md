...
## What the user gets
The Android app reads valid NFC tags and rejects invalid or unsafe tag data.
...
- Choose an NFC plugin or custom native bridge.
- Add NFC manifest capability where needed.
...
Generated: 2026-08-13T14:51:24.330Z
